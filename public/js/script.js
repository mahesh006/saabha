...
client.init("1e4cea4c7ad74774bb46a94414fba7f5",() => console.log("AgoraRTC client initialized") ,handleFail);
function call(){
// The client joins the channel
let anychannel= document.getElementById("roomName").innerHTML;
console.log(anychannel)
//let anychannel ="one";

client.join(null,anychannel,null, (uid)=>{    
